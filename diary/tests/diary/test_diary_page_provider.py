...
class TestDiaryPageRoutes:
    ...
    def test_is_not_diary(self, client):
        response_put = client.put("api/v1/diary/10", json={"name": "max1t1a"}, headers=headers)
    ...
    def test_add_page(self, client):
        response = client.post("api/v1/diary/2/page", json=TESTING_PAGE[0], headers=headers)
    ...
    def test_update(self, client):
        response = client.put("api/v1/diary/2/page/1", json={"name": "berupor_style", "body": "good test max1t1a"}, headers=headers)
    ...
    def test_is_not_page(self, client):
        response_put = client.put("api/v1/diary/10/page/1", json={"name": "max1t1a", "body": "qwerty_small"}, headers=headers)
